...
<html>
    ...
    <body>
        ...
        <div id="pg">
            <h2>¿Cómo se escribe una regla de CSS?</h2>
        </div>
        ...
        <div>
            ...
            <?php
                    $consulta1 = mysqli_query($conexion, "SELECT * FROM css2")or die(mysqli_error($conexion));
                    while($row = mysqli_fetch_assoc($consulta1)){
                        echo " <div class='css2'> " .$row['autor']." <br><br>
                        ".$row['titulo']."<br><br>
                        ".$row['comentario']."
                ...
                <?php
                    ...
                    if(isset($_POST['enviar'])){
                        ...
                        if($autor == '' or $titulo == '' or $comentario  == ''){
                            ...
                            window.location="CSS2.php";
                        </script>';
                        }
                        else{
                            $insertar = mysqli_query($conexion, "INSERT INTO css2(autor, titulo, comentario) VALUES ('".$autor."', '".$titulo."', '".$comentario."')")or die(mysqli_error($conexion));
                            echo '<script>
