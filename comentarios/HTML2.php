...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <?php
                    $consulta1 = mysqli_query($conexion, "SELECT * FROM html2")or die(mysqli_error($conexion));
                    while($row = mysqli_fetch_assoc($consulta1)){
                        echo " <div class='html2'> " .$row['autor']." <br><br>
                        ".$row['titulo']."<br><br>
                        ".$row['comentario']."
                ...
                <?php
                    ...
                    if(isset($_POST['enviar'])){
                        ...
                        if($autor == '' or $titulo == '' or $comentario  == ''){
                            ...
                            window.location="HTML2.php";
                        </script>';
                        }
                        else{
                            $insertar = mysqli_query($conexion, "INSERT INTO html2(autor, titulo, comentario) VALUES ('".$autor."', '".$titulo."', '".$comentario."')")or die(mysqli_error($conexion));
                            echo '<script>
